...
function Pricing() {
  return (
    <section className="pricing flex flex-col items-center pb-24 mt-16">
      <h2 className="pricing-title text-5xl font-bold mb-6">Choose Your Plan</h2> {/* Increased font size and margin */}

      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-24 py-16"> {/* Increased padding and gap */}
